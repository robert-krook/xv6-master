...
int 
uncompress (int code_length, const unsigned char *input, int input_length, unsigned char *out )
{
  int maxbits;
  int i, bit;
  int code, prev = -1;
...
int read_sub_blocks( int gif_file, unsigned char **data )
{
  int data_length;
  int index;
  unsigned char block_size;
...
int process_image_descriptor( int gif_file,
                                     rgb *gct,
                                     int gct_size,
                                     int resolution_bits )
{
...
int process_extension( int gif_file )
{
 ...
 */
void process_gif_stream( int gif_file )
{
