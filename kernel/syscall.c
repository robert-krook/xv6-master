...
/*
 *  syscall.c - handle the system calls
 */
...
extern int sys_GUI_select_style (void);
...
static int (*syscalls[])(void) = 
{
    ...
    [SYS_GUI_createWindow]      sys_gui_createWindow,           // Create window
    [SYS_GUI_closeWindow]       sys_GUI_closeWindow,            // Close window
    ...
    [SYS_date]                  sys_date,
    [SYS_df]                    sys_df,
    [SYS_GUI_select_style]      sys_GUI_select_style,
